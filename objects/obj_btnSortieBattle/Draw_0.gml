...
if(obj_base.menu_sortie_mode != 0){ //Drawing menu if pressed
	if(obj_base.menu_sortie_mode == 1){
		if(sub_menu_move == true){
			...
			draw_bev_rect(112,152,room_width,560,color.c_Pale_Blue_2,18,2,image_alpha);
...
draw_text_outline(200,455,color.c_Navy_Blue,color.c_Chalk_White,"Sortie out to the open waters \nand retake control of the seas.",2);
draw_self();
draw_set_alpha(1);