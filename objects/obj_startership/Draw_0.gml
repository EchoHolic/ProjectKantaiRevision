...
switch(selection){
   case 0:draw_sprite_ext(ship_0009_main,0,500,10,0.8,0.8,0,c_white,1);
   break;
   case 1:draw_sprite_ext(ship_0037_main,0,540,30,0.8,0.8,0,c_white,1);
   break;
   case 2:draw_sprite_ext(ship_0033_main,0,335,-10,0.8,0.8,0,c_white,1);
   break;
   case 3:draw_sprite_ext(ship_0046_main,0,460,30,0.8,0.8,0,c_white,1);
   break;
   case 4:draw_sprite_ext(ship_0094_main,0,525,0,0.8,0.8,0,c_white,1);
   break;
   case 5:draw_sprite_ext(ship_0410_main,0,450,0,0.8,0.8,0,c_white,1);
   break;
}
