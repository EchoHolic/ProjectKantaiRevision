...
if(selected >= 1 && selectedMap > 0){
	...
	if(alarm[0] != -1){
		...
		draw_bev_rect(740+xoffset,152,room_width,560,obj_saver.c_Dark_Blue,18,2,image_alpha);
		draw_bev_rect(742+xoffset,154,room_width,560,obj_saver.c_Navy_Blue_2,17,2,image_alpha);
		if(selectedWorld == 0){
...
if(selected == false && selectedMap == 0){
	if(alarm[0] != -1){
		if(xoffset < 0){
			draw_bev_rect(318+((room_width-318)*(11-alarm[0])/11),152,room_width,560,obj_saver.c_Dark_Blue,18,2,image_alpha);
			draw_bev_rect(320+((room_width-320)*(11-alarm[0])/11),154,room_width,560,obj_saver.c_Navy_Blue_2,17,2,image_alpha);
		}
		else{
